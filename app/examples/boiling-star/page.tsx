		...
		<>
			...
			<div className="fixed bottom-6 left-6 z-[1000] bg-black/60 backdrop-blur-md border border-white/10 p-5 max-w-[280px] font-mono">
				<div className="flex items-center gap-2 mb-2">
					...
					<strong className="text-xs uppercase tracking-widest text-orange-500">
						boiling_star
					</strong>
				</div>
				<p className="text-[10px] text-white/70 leading-relaxed mb-4">
					procedural star simulation with multi-layered simplex noise, dynamic
					surface warping, corona layer, and bloom post-processing.
				</p>
