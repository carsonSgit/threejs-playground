		...
		<>
			...
			<div className="fixed bottom-6 left-6 z-[1000] bg-black/60 backdrop-blur-md border border-white/10 p-5 max-w-[280px] font-mono">
				<div className="flex items-center gap-2 mb-2">
					<div className="h-1.5 w-1.5 bg-cyan-400 animate-pulse rounded-full" />
					<strong className="text-xs uppercase tracking-widest text-cyan-400">
						ascii_earth
					</strong>
				</div>
				<p className="text-[10px] text-white/70 leading-relaxed mb-4">
					rotating earth rendered with ascii characters using asciieffect.
					features interactive orbit controls and real-time texture processing.
				</p>
