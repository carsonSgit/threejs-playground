					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
							...
							<div className="h-48 relative overflow-hidden border-b border-border">
								...
								<div className="absolute inset-0 flex items-center justify-center">
									<div className="relative w-24 h-24">
										...
										<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full" style={{ background: 'radial-gradient(circle, rgba(6,182,212,0.2) 0%, transparent 70%)' }}></div>
									</div>
								</div>
						...
						>
							<div className="h-48 relative overflow-hidden border-b border-border">
								...
								<div className="absolute inset-0" style={{ background: 'radial-gradient(circle at center, rgba(234,88,12,0.6) 0%, rgba(185,28,28,0.5) 50%, rgba(0,0,0,1) 100%)' }}></div>
								...
								<div className="absolute inset-0 flex items-center justify-center">
									<div className="relative w-40 h-40">
										...
										<div className="absolute top-0 left-0 w-full h-full">
											<div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-full bg-gradient-to-b from-transparent via-yellow-300/40 to-transparent" style={{ transform: 'rotate(45deg)' }}></div>
											<div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-full bg-gradient-to-b from-transparent via-yellow-300/40 to-transparent" style={{ transform: 'rotate(-45deg)' }}></div>
										</div>
									</div>
								</div>
							...
							<div className="h-48 relative overflow-hidden border-b border-border">
								...
								<div className="absolute inset-0">
									...
									<svg className="absolute inset-0 w-full h-full opacity-30">
										<line x1="48" y1="32" x2="192" y2="64" stroke="rgba(192,132,252,0.4)" strokeWidth="1"/>
										<line x1="192" y1="64" x2="128" y2="96" stroke="rgba(232,121,249,0.4)" strokeWidth="1"/>
										<line x1="128" y1="96" x2="64" y2="128" stroke="rgba(244,114,182,0.4)" strokeWidth="1"/>
										<line x1="64" y1="128" x2="192" y2="160" stroke="rgba(192,132,252,0.4)" strokeWidth="1"/>
										<line x1="192" y1="160" x2="128" y2="192" stroke="rgba(232,121,249,0.4)" strokeWidth="1"/>
										<line x1="128" y1="96" x2="192" y2="128" stroke="rgba(244,114,182,0.4)" strokeWidth="1"/>
										<line x1="128" y1="96" x2="64" y2="160" stroke="rgba(192,132,252,0.4)" strokeWidth="1"/>
									</svg>
								</div>
						...
						>
							<div className="h-48 relative overflow-hidden border-b border-border">
								...
								<div className="absolute inset-0">
									{/* Main central blob */}
									<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full blur-sm" style={{ background: 'radial-gradient(circle, rgba(203,213,225,0.3) 0%, rgba(148,163,184,0.2) 50%, transparent 100%)' }}></div>
									
									{/* Secondary blobs */}
									<div className="absolute top-12 left-16 w-20 h-24 rounded-full blur-sm" style={{ borderRadius: '60% 40% 30% 70% / 60% 30% 70% 40%', background: 'radial-gradient(circle, rgba(209,213,219,0.25) 0%, rgba(156,163,175,0.15) 50%, transparent 100%)' }}></div>
									<div className="absolute bottom-16 right-20 w-18 h-22 rounded-full blur-sm" style={{ borderRadius: '30% 60% 70% 40% / 50% 60% 30% 60%', background: 'radial-gradient(circle, rgba(212,212,216,0.25) 0%, rgba(161,161,170,0.15) 50%, transparent 100%)' }}></div>
									<div className="absolute top-20 right-12 w-14 h-18 rounded-full blur-sm" style={{ borderRadius: '40% 60%', background: 'radial-gradient(circle, rgba(226,232,240,0.2) 0%, rgba(203,213,225,0.1) 50%, transparent 100%)' }}></div>
								</div>
